...
var initialScene = "skydio_x2/scene_test.xml";
...
export class MuJoCoDemo {
  constructor() {
    ...
    this.scene.fog = new THREE.Fog(this.scene.background, 100, 100 );
...
function controlDrone() {
    ...
    // Simple P controller (you can add I and D terms)
    const thrust = kp * error;
    
    // Apply control to all motors
    setThrust(thrust);
}
